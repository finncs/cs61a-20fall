...
def distance(city_a, city_b):
    ...
    5.0
    """
    dx = get_lon(city_a) - get_lon(city_b)
    dy = get_lat(city_a) - get_lat(city_b)
...
def closer_city(lat, lon, city_a, city_b):
    ...
    'Bucharest'
    """
    tmp_city = make_city('fake', lat, lon)
    tmp_to_a = distance(tmp_city, city_a)
    tmp_to_b = distance(tmp_city, city_b)
    if tmp_to_a > tmp_to_b:
